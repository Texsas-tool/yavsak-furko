...
# -----------------------------------------------------------
# Kodu Yapan ./Yusuf bu kod ibne furkan için yapıldı .
# ---------------------------------------------------------------
# -----------------------WARNA----------------------------
p = '\x1b[0m'
m = '\x1b[91m'
...
res = '\x1b[40m'
# -------------------------------------------------------
# python kodlamadır yapay zeka ile yapıldı
#------------------------Classes------------------------
class spam:
...
def logo():
 ...
 _ _                 __            _               
(_) |               / _|          | |              
 _| |__  _ __   ___| |_ _   _ _ __| | ____ _ _ __  
| | '_ \| '_ \ / _ \  _| | | | '__| |/ / _` | '_ \ 
| | |_) | | | |  __/ | | |_| | |  |   < (_| | | | |
|_|_.__/|_| |_|\___|_|  \__,_|_|  |_|\_\__,_|_| |_|
%s╭━┳━╭━╭━╮%s╮╲╲╲╲╲╲%s╔═╗╔═╗╔═╗╔╦╗
%s┃┈┈┈┣▅╋▅┫┃%s╲╲╲╲╲╲%s╚═╗╠═╝╠═╣║║║
%s┃┈┃┈╰━╰━━━━━━╮%s╲╲%s╚═╝╩  ╩ ╩╩ ╩                                                                                                     
%s╰┳╯┈┈┈┈┈┈┈┈┈◢▉◣%s╲%s╔═╗╔╦╗╔═╗
